...
class MicronParser {
 ...
 // wrap in container with page-level colors and line-height
 let containerStyle = "line-height:1.5;";
 ...
 return ` <!-- DOMPurify is not installed. Include it above micron-parser.js or run npm install dompurify -->`;
 }
 }
